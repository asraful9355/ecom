...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('categorys', 'sliders', 'products', 'featureds', 'hotDeals', 'specialOffers', 'specialDeals','category_skip_0','product_skip_0','category_skip_1','product_skip_1','category_skip_2','product_skip_2','category_skip_3','product_skip_3','category_skip_4','product_skip_4'));
    }
    ...
    public function subCategorywise_product_details($subcategory_id, $slug)
    {
        ...
        $categorys = Category::orderBy('category_name_en', 'ASC')->get();
        return view('frontend.product.subCategorywise_product',compact('products', 'categorys',));
    }
    ...
    public function subSubCategorywise_product_details($subsubcategory_id, $slug)
    {
        ...
        $categorys = Category::orderBy('category_name_en', 'ASC')->get();
        return view('frontend.product.subSubCategorywise_product',compact('products', 'categorys',));
    }
