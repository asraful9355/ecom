    ...
    <div class="row">
        <div class="box box-widget widget-user">
			...
			<div class="widget-user-image">
			  <img style="width: 80px; height: 80px" class="rounded-circle" src="{{ (!empty($admin->profile_photo_path)) ? url('upload/admin_images/'.$admin->profile_photo_path) : url('upload/no_image.jpg') }}" alt="UseAvatar">
			</div>
